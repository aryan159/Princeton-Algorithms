...
public class FastCollinearPointsSolution {
    private LineSegment[] segments = null;

    public FastCollinearPointsSolution(Point[] points) {
        if (points == null) {
        ...
        for (int i = 0; i < pointsCopy.length; i++) {
            ...
            for (int j = 1; j < slopeOrderedPoints.length; j++) {
                ...
                if (Double.compare(currentSlope, lastSlope) != 0) { // if currentSlopt != lastSlope
